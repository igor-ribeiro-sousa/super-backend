...
import com.crud.framework.service.GenericLeituraService;


public abstract class GenericLeituraServiceImpl<T, ID> implements GenericLeituraService<T, ID> {
	
    protected final GenericRepository<T, ID> repository;

    public GenericLeituraServiceImpl(GenericRepository<T, ID> repository) {
